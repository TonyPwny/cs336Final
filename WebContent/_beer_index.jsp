...
<form method="post" action="showBeer.jsp">
...
<br>
	<form method="post" action="_beer_sellsNewBeer.jsp">
	<table>
	<tr>    
...
<br>
	<form method="post" action="_beer_newBarBeerPrice.jsp">
	<table>
	<tr>    
	<td>Bar</td><td><input type="text" name="bar"></td>
	</tr>
...
<br>
	<form method="post" action="_beer_query.jsp">
